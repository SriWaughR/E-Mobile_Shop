...
<div class="row">
        ...
        <div class="col-md-6">
          <form action="/products/{{$mobile_curd->id}}/update" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row mb-2">
              <div class="col-md-12">
                ...
                <input
                  ...
                  placeholder="Product Name" value="{{old('name',$mobile_curd->name)}}"
                />
                @if($errors->has('name'))
            ...
            <div class="row mb-2">
              <div class="col-md-6">
                ...
                <input
                  ...
                  value="{{old('model',$mobile_curd->model)}}"
                />
                @if($errors->has('model'))
              ...
              <div class="col-md-6">
                ...
                <input
                  ...
                  value="{{old('quantity',$mobile_curd->quantity)}}"
                />
            ...
            <div class="row mb-2">
              <div class="col-md-12">
                ...
                <textarea
                  ...
                  >{{old('des',$mobile_curd->descreption)}}
                </textarea>
                @if($errors->has('des'))
